...
public class OnXIAODIBLEListener {
    ...
    public interface OnCommonListener{
        ...
        void failure(String errorCode, XIAODIDataReceivedAnalyzer xiaodiDataReceivedAnalyzer);//失败
    }
    ...
    public interface OnAddFingerListener {
        void fingerTemplateCollectionFailure(String errorCode, XIAODIDataReceivedAnalyzer xiaodiDataReceivedAnalyzer);//指纹模板采集失败
    ...
    public interface OnCheckManagePwdListener {
        void onCheckFailure(String errorCode, XIAODIDataReceivedAnalyzer xiaodiDataReceivedAnalyzer);//验证失败
