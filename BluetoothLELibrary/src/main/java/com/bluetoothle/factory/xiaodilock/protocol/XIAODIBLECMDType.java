...
public class XIAODIBLECMDType {
    ...
    public final static String BLE_CMDTYPE_GETSMARTKEYSECRETKEY = "com.dsm.ble.BLE_CMDTYPE_GETSMARTKEYSECRETKEY";                                   //获取智能钥匙通讯秘钥(0x50)
    public final static String BLE_CMDTYPE_QUERYSMARTKEYLOCKINFO = "com.dsm.ble.BLE_CMDTYPE_QUERYSMARTKEYLOCKINFO";                                 //查询智能钥匙下已有锁的信息(0x51)
    public final static String BLE_CMDTYPE_CLEANSMARTKEYINFO = "com.dsm.ble.BLE_CMDTYPE_CLEANSMARTKEYINFO";                                         //清空智能钥匙信息(0x52)
